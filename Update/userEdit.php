...
<body>
    ...
    <p>パイロットプロフィール編集画面</p>
    <form action="./pilotUserUpdate.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" value=<?= $id ?>>
        <label for="name">お名前</label>
        <input type="text" id="name" name="name" placeholder="お名前を入力してください" value="<?= $result['name'] ?>">
        <label for="kana">ふりがな（英字）</label>
        <input type="text" id="kana" name="kana" placeholder="ふりがなを入力してください" value="<?= $result['kana'] ?>">
        ...
        <input type="file" id="my_image" name="my_image" accept="images/*" capture="environment" value="<?= $result['my_image'] ?>" />
        <label for="work_area">活動地域</label>
        <input type="text" id="work_area" name="work_area" placeholder="活動地域を入力してください" value="<?= $result['work_area'] ?>">
        ...
        <input type="text" id="word" name="word" placeholder="word" value="<?= $result['word'] ?>">
        <label for="achievement">実績</label>
        <textarea name="achievement" id="achievement" cols="30" rows="10" placeholder="実績を入力してください"><?= $result['achievement'] ?></textarea>
        <label for="pr">PR</label>
        <textarea name="pr" id="pr" cols="30" rows="10" placeholder="PRしたいことを入力してください"><?= $result['pr'] ?></textarea>
