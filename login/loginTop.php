    ...
    <main id="top-Auth-main">
        <div id="login-area">
            <div class="user-auth">
                ...
                <p class="choice-SignUp">パイロットの方はこちらから<br>パイロットとしてお仕事をお探しの方は<br>上記からログインください</p>
            </div>
            ...
            <div class="user-auth">
                ...
                <p class="choice-SignUp">一般の方はこちらから<br>案件一覧をご覧になりたい方、ご依頼を掲載したい方は<br>上記からログインください</p>
            </div>
        </div>
